      ...
      <div className="mini-data-capture-form">
        <div className="form-inputs">
          <form>
            ...
            <input className={inputClassText} id="properties.phone" type="text" placeholder="Phone Number" value={this.props.phone} onChange={this.onChange} disabled={this.props.loading}/>
