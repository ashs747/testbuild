...
var layoutMixin = {
  ...
  setMediaQuery: function setMediaQuery(name, query) {
  ...
  isMatching: function isMatching(name) {
    return matching.indexOf(name) !== -1;
  },

  sameHeight: function sameHeight(containers, stretchEls) {
  ...
  sameHeightTrigger: function sameHeightTrigger() {
    $.each(this.windowListeners, (function (i) {
      this.windowListeners[i]();
    }).bind(this));
  },

  verticalAlign: function verticalAlign(el) {
